...
def generate_image(width = 320, height = 240):
  img = Image(width=0, height=0, encoding='mono8')
  img.data = np.random.randint(0, 255, size=(width, height))
  return(img)
...
def main() -> None:
  ...
  while not rospy.is_shutdown():
    ...
    #publisher.publish(Image(width=0, height=0, encoding='mono8'), generate_image(width = 320, height = 240))
